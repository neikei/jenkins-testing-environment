...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  config.vm.provider "virtualbox" do |vb|
      ...
      vb.customize ["modifyvm", :id, "--name", "jenkins-testing-environment"]
  end
  ...
  # Post-up message
  config.vm.post_up_message = "See https://github.com/neikei/jenkins-testing-environment for help and bug reports."
